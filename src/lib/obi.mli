...
module Index : sig
  ...
  type metadata =
    { rev: string;  (** opam-repository git revision hash that this run was built against *)
      params: params; (** build {!params} for this run *)
      build_result: result; (** result of the execution of this set of parameters *)
      start_time: float; (** wall clock start time of the build in Unix seconds *)
  ...
  type pkg =
   { name: string; (** opam package name *)
     ...
     mutable tags: string list; (** list of tags associated with this package. As a heuristic, all of the tags listed of all versions are bundled together here for simplicity. *)
